const { RestClient } = require('bitmart-api');
  ...
  // ENDPOINT: spot/v4/query/client-order
  // METHOD: POST
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/bitmart-api/blob/master/src/RestClient.ts#L402
...
client.getSpotOrderByClientOrderIdV4(params)
  .then((response) => {
