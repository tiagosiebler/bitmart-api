const { RestClient } = require('bitmart-api');
  ...
  // ENDPOINT: spot/v1/trade_fee
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/bitmart-api/blob/master/src/RestClient.ts#L318
...
client.getActualSpotTradeFeeRateV1(params)
  .then((response) => {
