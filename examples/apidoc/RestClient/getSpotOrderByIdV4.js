const { RestClient } = require('bitmart-api');
  ...
  // ENDPOINT: spot/v4/query/order
  // METHOD: POST
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/bitmart-api/blob/master/src/RestClient.ts#L393
...
client.getSpotOrderByIdV4(params)
  .then((response) => {
