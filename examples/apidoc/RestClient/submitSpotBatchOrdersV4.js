const { RestClient } = require('bitmart-api');
  ...
  // ENDPOINT: spot/v4/batch_orders
  // METHOD: POST
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/bitmart-api/blob/master/src/RestClient.ts#L357
...
client.submitSpotBatchOrdersV4(params)
  .then((response) => {
